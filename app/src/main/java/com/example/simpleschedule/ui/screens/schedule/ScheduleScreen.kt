...
fun ScheduleScreen(
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    ...
                    Text("当前版本：v2.0.0", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
    ...
    if (showAbout) {
        AlertDialog(
            ...
            text = {
                Column {
                    Text("版本 2.0.0", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                    Spacer(modifier = Modifier.height(8.dp))
