...
fun ScheduleScreen(
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    ...
                    Text("当前版本：v1.2.0", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                ...
                TextButton(onClick = {
                    ...
                    try {
                        ...
                        dm.enqueue(android.app.DownloadManager.Request(android.net.Uri.parse(url)).apply {
                            ...
                            setDestinationInExternalPublicDir(android.os.Environment.DIRECTORY_DOWNLOADS, "课程通_v${updateInfo.latestVersion}.apk")
                        })
                        android.widget.Toast.makeText(context, "正在下载，请查看通知栏", android.widget.Toast.LENGTH_SHORT).show()
                    } catch (e: Exception) {
    ...
    if (showAbout) {
        AlertDialog(
            ...
            text = {
                Column {
                    Text("版本 1.2.0", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                    Spacer(modifier = Modifier.height(8.dp))
